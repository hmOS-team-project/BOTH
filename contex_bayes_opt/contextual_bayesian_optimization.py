...
from .gp_util import acq_max
from sklearn.gaussian_process import GaussianProcessRegressor

class ContextualBayesianOptimization():
    def __init__(self, all_actions_dict, contexts, kernel, contexts_dim, actions_dim, embedding_dim, noise=1e-6, points=[], rewards=[], init_random=5):

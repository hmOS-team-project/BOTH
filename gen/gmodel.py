...
from gurobipy import Model, Env, GRB, read, LinExpr, and_
import numpy as np

class GModel(object):  # Gurobi model

    def __init__(self, num_tasks=20, num_workers=5, max_dur=100, logfilename='', bigM=300, threads=0):
        self.bigM = bigM

...
from contex_bayes_optimization.linear_ucb_optimization import LinUCBOptimizer
...
if __name__ == '__main__':
    ...
    for count in range(num_repeat):
        ...
        for i_problem in range(1, total_no + 1):
            ...
            # Record makespan and accuracy metrics of the problem in current iteration
                ...
                optimizer = LinUCBOptimizer(all_actions_dict=discvars, 
                                contexts=contexts, 
                ...
                print('LinUCB decision starts: Repeat_{}/taskID_{}/BatchID_{}'.format(count, i_problem, i_b))
                ...
                end_t = time.time()
                # print('LinUCB decision-making time: {}'.format(end_t - start_t))
    ...
    # 将结果打印到txt文件
    results_file_path = os.path.join(save_folder, "linUCB_eval_results.txt")
